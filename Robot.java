...
public class Robot extends TimedRobot {
  ...
  public static Shooty shooty = new Shooty();

  private Command m_autonomousCommand;
  DifferentialDrive m_Drive;


  static WPI_TalonFX frontright = new WPI_TalonFX(3);
  static WPI_TalonFX frontleft = new WPI_TalonFX(2);
  static WPI_TalonFX backright = new WPI_TalonFX(4);
  static WPI_TalonFX backleft = new WPI_TalonFX(1);

  public Joystick D_HOES = new Joystick(0);
  ...
  public void robotPeriodic() {
    // Runs the Scheduler. polling buttons, adding newly-scheduled
  ...
  /*public static void ArcadeDrive(double rawAxis, double rawAxis2) {
